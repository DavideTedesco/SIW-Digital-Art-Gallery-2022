...
/*Autore
insert into autore(id, cognome, data_di_nascita, luogo_di_nascita, nome) values('100', 'Van Gogh', '2020-12-15', 'Amsterdam', 'Vincent');*/

/*Collezione
insert into collezione(id, descrizione, nome) values('300', 'Piccola collezione', 'Grand Collection');*/

/*Opera
insert into opera(id, anno_di_realizzazione, descrizione, immagine, nome, autore_id,collezione_id) values('200', '2020-12-15','Una bella opera', '', 'I girasoli', '100','300');*/
