...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	//metodo per la configurazione dell'autenticazione e autorizzazione
    @Override
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**", "/errorLogin", "/error").permitAll()
	...
	//metodo che fornisce le query per ottenere usarname e password
